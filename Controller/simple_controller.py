...
class SimpleFeedbackController:
    ...
    def __init__(self, lstm_model, kp=10.0, kd=0.15, ki=0.12):
        """
        Args:
        ...
        self.u_hover = 0.40  # Feed-forward value for hovering
...
class SimpleControllerGUI:
    ...
    def __init__(self, root, model_path):
        ...
        self.controller = SimpleFeedbackController(self.lstm_model, kp=0.2)
